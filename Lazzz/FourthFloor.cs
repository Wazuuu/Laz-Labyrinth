...
namespace LazLabyrinth
{
	...
	class FourthFloor
	{
		...
		public static void FirstEncounter()
		{
			...
			Console.WriteLine("With the third floor cleared, you progress to the fourth floor entrance.");
			Console.WriteLine("A harsh cold wind blew pass you immediately... A winter climate, with trees devoid of its leave due to the climate.");
			Console.WriteLine("With a shivering step, you move forward trudging through ankle deep snow.");
			Console.WriteLine("Like the previous floors, there is a clearing in the middle. Glowing eyes watching your every move.");
			Console.WriteLine("You see what seems to be a tiny creature, holding a small dagger with one hand behind it was a swarm of them. Posing to attack you.");
			Console.WriteLine("It pounces onto you and you blocked it with your sword....+");
			Console.ReadKey();
			Combat(false, "Gremlins", 5, 8);
			RunGame();
		}
		public static void BasicEncounter()
		{
			Console.Clear();
			CmpltnLaz.PrintLogo4();
			Console.WriteLine("After you defeat it more and more continuing to attack you. They seem to be ready for more...");
			Console.ReadKey();
			Combat(true,"",0,0);
		}
		public static void IfBoss()
        {
            ...
            if (ans.ToLower() == "y" || ans.ToLower() == "yes")
            {
                ...
                Console.Clear();
                CmpltnLaz.PrintLogo4();
                Console.WriteLine("Congratulations on defeating the fourth boss!");
                Console.ReadKey();
                FifthFloor.FirstEncounter();
		...
		public static void Boss()
		{
			Console.Clear();
			CmpltnLaz.PrintLogo4();
			Console.WriteLine("It looks like a human with pale skin, donning dark colored attire. With two fang like teeth protruding from its lips. This creature is called a Vampyre, beings that are nigh immortal with intelligence of a normal human. Only having weaknesses to silver weapons.");
			Console.ReadKey();
			Combat(false, "Blaviken, Bloodless Eternal", 5, 8);
		}
		//Encounter Tools
		...
		public static void Combat(bool random, string name, int power, int health)
		{
			...
			while (h > 0)
			{
				...
				if (input.ToLower() == "a" || input.ToLower() == "attack")
				{
					...
					if (damage < 0)
						damage = 0;
					int attack = Program.currentPlayer.weaponValue + rand.Next(6,6);
